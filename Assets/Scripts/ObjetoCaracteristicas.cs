...
public class ObjetoCaracteristicas : MonoBehaviour
{
    ...
    public void ConfigurarObjeto(string nombre, string Grou, string Value, string control)
    {
        nombreObjeto = nombre;
        nombreGrupo = Grou;
        Valor_objet = Value;
    ...
    public void SumarValor()
    {
        if (puedeSumar)
        {
            ...
            ControladorSuma.SUMA += int.Parse(Valor_objet);
